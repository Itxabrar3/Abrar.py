...
##### LOGO #####
logo1 = """
\033[1;93m    __      ___    ___      __      ___  
\033[1;92m    / /\    | |_)   | |_)    / /\    | |_) 
\033[1;94m /_/- - \  |_|_)  |_| \  /_/--\   |_| \ 
\033[1;91m

\033[1;91m--> INSTAGRAM  :- abraar_khaan7
\033[1;92m--> FACEBOOK   :- ItxAbrar.khan
\033[1;93m--> YOUTUBE    :- Abrar Status Official
\033[1;95m--> NOTE       :- SOMETHING YOUR
...
CorrectUsername = "Abrar"
CorrectPassword = "Abrar"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Abrar
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By Abrar Khan" #Dev:Abrar
	print '\033[1;94mProcess Has Been Completed \033[1;94m....'
        print '\033[1;92mType (python2 Abrar.py) New Fb Start Cloning\033[1;92m....'
